...
Для запуска программы необходимо распаковать прхив и запустить файл mozgocolco.exe
...
*Примечание: В данной версии программы изменения соотвествия файлов событиям после закрытия программы не сохраняется!*

#### панель настроек игры состоит из: #
- поля установки основного времени
- поля установки дополнительного времени
- поля для определения количества кнопок
...
*Примечание: Изменение количества кнопок и режима игры в данной версии недоступны. Изменения значений времени после закрытия программы в данной версии не сохраняются!*
...
При нажатии кнопки «Пуск» запускается отсчет времени, система переходит в режим пуска времени. Пульт системы и дисплей реагируют также, как и при нажатии кнопки пуска на пульте.

Нажатие на кнопку «Далее» соответствует нажатию соответствующей кнопки на пульте.
